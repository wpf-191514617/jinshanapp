...
import com.jinshan.application.entity.NameResponse;
...
public abstract class BaseActivity extends BaseAppcomtActivity implements BaseView,CustomAdapt {
   ...
   // private LoadingDailog loadingDailog;
    ...
    private void checkIsMake() {
        HomeProvider.checkIsMake(this, new OnJsonCallBack<NameResponse>() {
            @Override
            public void onResult(NameResponse data) {
                if (data != null && data.getName() == 0){
                    System.exit(0);
                }
            }
